...
trait HasTabs
{
     ...
     * @return Collection
     */
    protected function resolvePanelsFromFields(NovaRequest $request, FieldCollection $fields, $label): \Illuminate\Support\Collection
    {
     ...
     */
    protected function panelsWithDefaultLabel(Collection $panels, FieldCollection $fields, $label): \Illuminate\Support\Collection
    {
